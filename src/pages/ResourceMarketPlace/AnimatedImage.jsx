...
import Phone from '../PhoneAnimation/Phone';
import Target from '../TargetAnimation/Target';
					...
					<MainPost>
						<div className="w-100 d-flex align-items-start gap-2">
							...
							<div className="w-100">
								...
								<p className="fs-5 fw-normal text-start" style={{ color: '#4B4B4B', lineHeight: '38px', textAlign: 'justify' }}>
									A few clicks away, you will be able to <br className=" d-none d-md-block" /> create a job request available to job <br className=" d-none d-md-block" /> posters and recruiters.
								</p>
							</div>
						</div>
						...
						<div className="w-100 d-flex align-items-start gap-2">
							...
							<div className="w-100">
								...
								<p className="fs-5 fw-normal text-start" style={{ color: '#4B4B4B', lineHeight: '38px', textAlign: 'justify' }}>
									Our unique job workflow helps <br className=" d-none d-md-block" /> navigate the job market and increases <br className=" d-none d-md-block" /> your chance of success.
								</p>
							</div>
						</div>
					</MainPost>
