...
const JobSection = () => {
  ...
  return (
    <>
    <div className="px-2 m-0 gap-5   px-md-5">
      <div className="d-flex align-items-center justify-content-center">
      <div className="row mx-0 px-4 px-lg-5 mt-0  mt-md-4 mb-0 mb-md-5 align-items-center job-container w-100      custom-row-reverse" style={{maxWidth:"1400px"}} >
        <div className="col-sm-12 d-flex flex-column my-md-5 mt-4 mb-5 px-0 px-md-5 custom-padding-left">
         
            <h1 className="header-titles" >Job workflow</h1>
      ...
      {/* <div className="row m-0 gap-0 px-3 px-lg-5 px-lg-5 my-lg-5   align-items-center w-100 justify-content-between custom-row-reverse job-container  ">
        <div className="col-sm-12  col-md-6 col-lg-6  d-flex flex-column custom-padding-left" style={{maxWidth:'42.33rem'}}>
  ...
  <div className="pt-0    pt-md-0 pt-md-5 mt-0 mt-lg-5  d-flex w-full align-item-center justify-content-center">
  <div className="main-container-job-section ">
        
        <div className="left-job-container inner-container">
        ...
        <div className="right-job-container inner-container">
