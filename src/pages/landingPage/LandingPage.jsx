              ...
              >
                ...
                <div className={`sub-menu ${subMenu ? "active" : ""}`}>
                  ...
                  <div>
                    ...
                    <p onClick={() => navigate("/resources-marketplace")}>Resources marketplace</p>
                  </div>
                </div>
              </span>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-3">
            <div className="contents">
              ...
              <p  onClick={() => navigate("/contact-us")}>Jobs Marketplace</p>
              <p  onClick={() => navigate("/contact-us")}>Resources Marketplace</p>
            </div>
          </div>
          <div className="col-sm-12 col-md-3">
            <div className="contents">
              ...
              <p  onClick={() => navigate("/how-to")}>How to</p>
            </div>
          </div>
          <div className="col-sm-12 col-md-3">
            <div className="contents">
              <p className="heading">Company</p>
              <p className="cursor-pointer" onClick={() => navigate("/our-story")}>Our story</p>
